...
const CustomerRegister: React.FC = () => {
  ...
  return (
    <AuthRegisterForm
      title="יצירת חשבון"
      fields={[
        { name: 'nameCust', label: 'שם מלא', type: 'text', value: formData.nameCust, placeholder: 'ישראל ישראלי' },
        { name: 'emailCust', label: 'אימייל', type: 'email', value: formData.emailCust, placeholder: 'example@mail.com' },
        { name: 'passwordCust', label: 'סיסמה', type: 'password', value: formData.passwordCust, placeholder: 'לפחות 6 תווים' },
      ]}
