...
namespace Repository.Entities
{
    ...
    public class ChatSession
    {
        ...
        public double EstimatedWaitTime { get; set; } // זמן המתנה בדקות
        public SessionStatus statusChat { get; set; } // מצב השיחה
        public bool status { get; set; }//סטטוס (למחיקה
        public int? IDRepresentative { get; set; }// מזהה נציג
        [ForeignKey("IDRepresentative")]
        public virtual Representative Representative { get; set; }
        public int IDCustomer { get; set; }//מזהה לקוח
        [ForeignKey("IDCustomer")]
        public virtual Customer Customer { get; set; }
        public int IDTopic { get; set; }//מזהה שיחה
        [ForeignKey("IDTopic")]
